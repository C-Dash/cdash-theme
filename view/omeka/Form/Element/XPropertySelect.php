...
class PropertySelect extends AbstractVocabularyMemberSelect
{
    ...
    public function getValueOptions(): array
    {
        ...
        foreach ($valueOptions as $propertyId => $option) {
            ...
            if ($altLabels) {
            //These bits commented out for CDASH by pbc 
            ...
            // Replaced by this line per 
            // https://forum.omeka.org/t/display-only-alternate-labels-on-advanced-search-page/9870
                $valueOptions[$propertyId]['label'] = 'freddy';
            }
        }
